        ...
        <div class="col-md-6">
          ...
          <div class="mb-4">
            ...
            <select name="gender" id="gender" class="form-select @error('gender') is-invalid @enderror">
              ...
              <option value="Laki - Laki" {{ old('gender', $client->gender) === Constant::MALE ? 'selected' : '' }}>{{ Constant::MALE }}</option>
              <option value="Perempuan" {{ old('gender', $client->gender) === Constant::FEMALE ? 'selected' : '' }}>{{ Constant::FEMALE }}</option>
            </select>
            @error('gender')
              <div class="invalid-feedback">{{ $message }}</div>
            @enderror
